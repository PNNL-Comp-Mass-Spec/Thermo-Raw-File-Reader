...
namespace RawFileReaderTests
{
    ...
    {
        // Ignore Spelling: cd, noresult, cnl, msx, sa, cid, etd, hcd, pqd, ETciD, EThcD, sid, sps
        ...
        public void DetermineMRMScanType(string filterText, MRMScanTypeConstants expectedResult)
        {
            ...
            Assert.That(mrmScanType, Is.EqualTo(expectedResult));
        }
        ...
        [TestCase("ASTMS + c NSI d Full ms2 833.4459@hcd28.55 [150.0000-1500.0000]   ", IonModeConstants.Positive)]
        ...
        public void DetermineIonizationMode(string filterText, IonModeConstants expectedResult)
        {
            ...
            Assert.That(ionizationMode, Is.EqualTo(expectedResult));
        }

        [Test]
        [TestCase("FTMS + p NSI Full ms [400.00-2000.00]                                ", "")]
        [TestCase("ITMS + c ESI Full ms [300.00-2000.00]                                ", "")]
        [TestCase("ASTMS + c NSI d Full ms2 833.4459@hcd28.55 [150.0000-1500.0000]      ", "")]
        ...
        public void ExtractMRMMasses(string filterText, string expectedMassList)
        {
            ...
            {
                Assert.That(mrmInfo.MRMMassList, Has.Count.Zero, "Mass range count mismatch");
                return;
            }

            var expectedMassRanges = expectedMassList.Split(';');
            Assert.That(mrmInfo.MRMMassList, Has.Count.EqualTo(expectedMassRanges.Length), "Mass range count mismatch");
        ...
        [TestCase("ASTMS + c NSI d Full ms2 833.4459@hcd28.55 [150.0000-1500.0000]                  ", 2, "833.4459@hcd28.55 [150.0000-1500.0000]")]
        ...
        public void ExtractMSLevel(string filterText, int expectedMSLevel, string expectedMzText)
        {
            ...
            {
                Assert.That(success, Is.False, "ExtractMSLevel returned true; expected false");
                return;
            }
        ...
        [TestCase("ASTMS + c NSI d Full ms2 833.4459@hcd28.55 [150.0000-1500.0000]                  ", "833.4459", 2, "hcd")]
        ...
        public void ExtractParentIonMZFromFilterText(string filterText, string expectedParentIons, int expectedMSLevel, string expectedCollisionMode)
        {
            ...
            {
                Assert.That(success, Is.False, "ExtractParentIonMZFromFilterText returned true; should have returned false");
                return;
            }

            Assert.That(success, Is.True, "ExtractParentIonMZFromFilterText returned false");
            ...
            if (expectedParentIonList.Length > 0)
            {
                for (var i = 0; i < expectedParentIonList.Length; i++)
                {
                    ...
                    Assert.That(actualParentIonMz, Is.EqualTo(expectedParentIonMz).Within(.001),
        ...
        /// <param name="expectedParentIons">ParentIon Mz (could be comma-separated list, with ! marking the "best" parent ion m/z)</param>
        [Test]
        [TestCase("+ c d Full ms3 1312.95@45.00 873.85@45.00 [ 350.00-2000.00]                      ", "1312.95, 873.85!")]
        [TestCase("ITMS + c NSI d Full ms10 421.76@35.00                                            ", "421.76")]
        [TestCase("ITMS + c NSI d sa Full ms2 467.16@etd100.00 [50.00-1880.00]                      ", "467.16")]
        [TestCase("ITMS + c NSI d Full ms2 467.16@etd100.00 [50.00-1880.00]                         ", "467.16")]
        [TestCase("ITMS + c NSI d Full ms2 756.98@cid35.00 [195.00-2000.00]                         ", "756.98")]
        [TestCase("ITMS + c NSI d Full ms2 606.30@pqd27.00 [50.00-2000.00]                          ", "606.3")]
        ...
        [TestCase("ASTMS + c NSI d Full ms2 833.4459@hcd28.55 [150.0000-1500.0000]                  ", "833.4459")]
        ...
        [TestCase("+ c NSI SRM ms2 748.371 [701.368-701.370, 773.402-773.404, 887.484-887.486, 975.513-975.515]", "748.371")]
        [TestCase("+ c NSI SRM ms2 501.560@cid15.00 [507.259-507.261, 635-319-635.32]               ", "501.56")]
        [TestCase("+ p NSI SRM ms2 1025.250 [300.000-1500.00]                                       ", "1025.250")]
        [TestCase("FTMS + p NSI d Full msx ms2 712.85@hcd28.00 407.92@hcd28.00  [100.00-1475.00]    ", "712.85!, 407.92")]
        [TestCase("ITMS + c NSI r d sa Full ms2 1073.4800@etd120.55@cid20.00 [120.0000-2000.0000]   ", "1073.48")]
        [TestCase("ITMS + c NSI r d sa Full ms2 1073.4800@etd120.55@hcd30.00 [120.0000-2000.0000]   ", "1073.48")]
        [TestCase("FTMS + p NSI Full ms                                                             ", "0")]
        [TestCase("0                                                                                                                            ", "0")]
        [TestCase("ITMS + p NSI d Z ms [351.00-361.00]                                                                                          ", "0")]
        [TestCase("ITMS + c NSI Full ms [150.00-700.00]                                                                                         ", "0")]
        [TestCase("ITMS + p NSI SIM ms [329.10-335.10]                                                                                          ", "0")]
        [TestCase("ITMS + p NSI CRM ms3 332.14@cid35.00 288.10@cid35.00 [240.00-250.00, 309.00-319.00]                                          ", "332.14, 288.10!")]
        [TestCase("ITMS + p NSI SRM ms2 332.00@cid35.00 [283.00-293.00]                                                                         ", "332.00")]
        [TestCase("ITMS + c NSI Full ms2 195.00@cid35.00 [50.00-300.00]                                                                         ", "195.00")]
        [TestCase("ITMS + p NSI CRM ms4 332.00@cid50.00 288.00@cid50.00 245.00@cid0.00 [200.00-300.00]                                          ", "332.00, 288.00, 245.00!")]
        [TestCase("FTMS + p NSI d Full ms2 819.00@cid35.00 [215.00-830.00]                                                                      ", "819.00")]
        [TestCase("FTMS + p NSI d Full ms2 819.00@etd20.00 [100.00-830.00]                                                                      ", "819.00")]
        [TestCase("FTMS + p NSI Full ms [400.00-2000.00]                                                                                        ", "0")]
        [TestCase("ITMS - p NSI d Full ms [100.00-300.00]                                                                                       ", "0")]
        [TestCase("ITMS - p NSI Full ms [100.00-300.00]                                                                                         ", "0")]
        [TestCase("FTMS + p NSI d Full ms2 1161.19@pqd35.00 [50.00-2000.00]                                                                     ", "1161.19")]
        [TestCase("ITMS + c NSI d Full ms2 370.98@cid35.00 [90.00-755.00]                                                                       ", "370.98")]
        [TestCase("ITMS + c NSI d Full ms3 346.00@cid35.00 258.07@cid35.00 [60.00-530.00]                                                       ", "346.00, 258.07!")]
        [TestCase("ITMS + c NSI d Full ms4 205.09@cid35.00 177.09@cid35.00 131.08@cid35.00 [50.00-275.00]                                       ", "205.09, 177.09, 131.08!")]
        [TestCase("ITMS + c NSI Full ms3 332.10@cid35.00 288.10@cid35.00 [75.00-350.00]                                                         ", "332.10, 288.10!")]
        [TestCase("ITMS + c NSI SIM ms [286.50-289.50]                                                                                          ", "0")]
        [TestCase("FTMS + p ESI Full ms [300.00-1700.00]                                                                                        ", "0")]
        [TestCase("ITMS + c ESI d w Full ms2 323.44@cid35.00 [75.00-660.00]                                                                     ", "323.44")]
        [TestCase("FTMS + c NSI Full ms [400.00-1700.00]                                                                                        ", "0")]
        [TestCase("FTMS - c NSI Full ms [400.00-1700.00]                                                                                        ", "0")]
        [TestCase("ITMS + p NSI d Full ms2 901.47@cid30.00 [235.00-1815.00]                                                                     ", "901.47")]
        [TestCase("FTMS - p NSI Full ms2 652.20@cid0.00 [175.00-1200.00]                                                                        ", "652.20")]
        [TestCase("FTMS - c NSI Full ms2 223.03@hcd32.00 [50.00-475.00]                                                                         ", "223.03")]
        [TestCase("ITMS - p NSI d Full ms2 145.01@cid35.00 [50.00-305.00]                                                                       ", "145.01")]
        [TestCase("FTMS - p NSI Full ms [70.00-910.00]                                                                                          ", "0")]
        [TestCase("ITMS - p NSI d Full ms3 347.50@cid35.00 317.88@cid35.00 [75.00-650.00]                                                       ", "347.50, 317.88!")]
        [TestCase("FTMS + p NSI Full ms2 480.30@hcd28.00 [66.67-1000.00]                                                                        ", "480.30")]
        [TestCase("FTMS + p NSI d Full ms2 613.39@hcd32.00 [100.00-1240.00]                                                                     ", "613.39")]
        [TestCase("ITMS + p NSI Full ms [400.00-2000.00]                                                                                        ", "0")]
        [TestCase("FTMS + c NSI d Full ms2 413.27@hcd30.00 [100.00-865.00]                                                                      ", "413.27")]
        [TestCase("ITMS + c NSI d w Full ms2 371.10@cid35.00 [90.00-385.00]                                                                     ", "371.10")]
        [TestCase("FTMS + c NSI d Full ms3 437.26@cid35.00 654.47@hcd45.00 [100.00-2000.00]                                                     ", "437.26, 654.47!")] // ms2 is cid
        [TestCase("FTMS + p NSI sid=30.00  Full ms [500.00-2000.00]                                                                             ", "0")]
        [TestCase("FTMS + c NSI sid=30.00  d Full ms2 859.56@hcd30.00 [100.00-2000.00]                                                          ", "859.56")]
        [TestCase("ITMS - c NSI d Full ms2 191.87@cid35.00 [50.00-780.00]                                                                       ", "191.87")]
        [TestCase("ITMS + c NSI r d Full ms2 421.8336@hcd35.00 [110.0000-854.0000]                                                              ", "421.8336")]
        [TestCase("FTMS - p ESI Full ms [50.00-500.00]                                                                                          ", "0")]
        [TestCase("FTMS - c ESI d Full ms2 112.99@cid35.00 [50.00-350.00]                                                                       ", "112.99")]
        [TestCase("FTMS - c ESI d Full ms3 226.98@cid35.00 117.02@cid35.00 [50.00-365.00]                                                       ", "226.98, 117.02!")]
        [TestCase("- p NSI Full ms2 218.110 [50.100-250.000]                                                                                    ", "218.110")]
        [TestCase("FTMS + p NSI sa Full ms2 968.57@etd10.00 [200.00-2000.00]                                                                    ", "968.57")]
        [TestCase("ITMS + p NSI d Full ms2 430.89@etd150.00 [50.00-875.00]                                                                      ", "430.89")]
        [TestCase("+ p NSI Full pr 150.000 [150.100-400.000]                                                                                    ", "0")]
        [TestCase("+ p NSI Q1MS [150.100-400.000]                                                                                               ", "0")]
        [TestCase("FTMS + p NSI Full ms2 1100.00@cid0.00 [300.00-2000.00]                                                                       ", "1100.00")]
        [TestCase("FTMS + c NSI Full ms2 808.41@hcd28.00 [100.00-2000.00]                                                                       ", "808.41")]
        [TestCase("ITMS + p NSI sid=35.00  Full ms [210.00-2000.00]                                                                             ", "0")]
        [TestCase("FTMS + p NSI Full msx ms2 636.04@hcd28.00 641.04@hcd28.00 654.05@hcd28.00 [88.00-1355.00]                                    ", "636.04, 641.04, 654.05")]
        [TestCase("FTMS + c NSI Full msx ms2 818.12@hcd27.00 863.14@hcd27.00 838.13@hcd27.00 638.04@hcd27.00 [88.33-1785.00]                    ", "818.12, 863.14, 838.13, 638.04")]
        [TestCase("FTMS + p NSI SIM ms [521.90-523.90]                                                                                          ", "0")]
        [TestCase("FTMS + c NSI d Full ms2 1303.24@cid35.00 [345.00-2000.00]                                                                    ", "1303.24")]
        [TestCase("FTMS + p NSI Full ms2 881.00@etd200.00 [240.00-2000.00]                                                                      ", "881.00")]
        [TestCase("FTMS + p NSI sid=35.00  Full ms2 994.00@cid35.00 [270.00-2000.00]                                                            ", "994.00")]
        [TestCase("FTMS + p NSI sid=35.00  Full ms2 994.00@etd100.00 [400.00-2000.00]                                                           ", "994.00")]
        [TestCase("FTMS + p NSI sid=35.00  Full ms2 994.00@hcd1.00 [500.00-2000.00]                                                             ", "994.00")]
        [TestCase("ITMS + c NSI sid=35.00  d Full ms2 445.12@cid35.00 [110.00-460.00]                                                           ", "445.12")]
        [TestCase("FTMS + c NSI Full ms2 612.78@cid35.00 [165.00-2000.00]                                                                       ", "612.78")]
        [TestCase("FTMS + c NSI Full ms3 559.30@cid35.00 421.51@cid35.00 [115.00-2000.00]                                                       ", "559.30, 421.51!")]
        [TestCase("FTMS {0,0}  - p NSI Full ms [250.00-2400.00]                                                                                 ", "0")]
        [TestCase("ITMS + c NSI r d Full ms2 394.7961@cid30.00 [103.0000-800.0000]                                                              ", "394.7961")]
        [TestCase("ITMS + c NSI r d Full ms2 626.4867@etd30.14 [120.0000-2000.0000]                                                             ", "626.4867")]
        [TestCase("ITMS + c NSI r d sa Full ms2 437.5289@etd53.58@cid20.00 [120.0000-1323.0000]                                                 ", "437.5289")]
        [TestCase("ITMS + c NSI r d sa Full ms2 437.5289@etd53.58@hcd20.00 [120.0000-1323.0000]                                                 ", "437.5289")]
        [TestCase("- c NSI Q3MS [65.000-900.000]                                                                                                ", "0")]
        [TestCase("ITMS + c NSI sid=5.00  Full ms [150.00-2000.00]                                                                              ", "0")]
        [TestCase("ITMS - c NSI Full ms [75.00-1500.00]                                                                                         ", "0")]
        [TestCase("ITMS + p NSI Z ms [150.00-2000.00]                                                                                           ", "0")]
        [TestCase("+ c NSI Full ms2 856.930 [300.000-1200.000]                                                                                  ", "856.930")]
        [TestCase("ITMS + c NSI d Full ms2 916.13@pqd28.50 [50.00-2000.00]                                                                      ", "916.13")]
        [TestCase("ITMS + c NSI d sa Full ms2 377.19@etd100.00 [50.00-1145.00]                                                                  ", "377.19")]
        [TestCase("+ c NSI Full cnl 162.053 [300.000-1200.000]                                                                                  ", "0")]
        [TestCase("- c NSI Full pr 225.007 [300.000-1200.000]                                                                                   ", "0")]
        [TestCase("- c NSI Q1MS [600.000-1000.000]                                                                                              ", "0")]
        [TestCase("- c NSI d Full ms2 671.207 [10.000-676.207]                                                                                  ", "671.207")]
        [TestCase("- p NSI Q3MS [807.100-810.100, 851.100-854.100]                                                                              ", "0")]
        [TestCase("FTMS + p EI Full ms [50.00-600.00]                                                                                           ", "0")]
        [TestCase("FTMS + p EI Full lock ms [50.00-600.00]                                                                                      ", "0")]
        [TestCase("FTMS + p NSI sps d Full ms3 432.8866@hcd30.00 149.0201@hcd65.00 [110.0000-500.0000]                                          ", "432.8866, 149.0201!")]
        [TestCase("FTMS + c ESI d Full ms2 391.29@hcd30.00 [90.00-405.00]                                                                       ", "391.29")]
        [TestCase("ITMS + c ESI d Full ms2 391.29@cid35.00 [65.00-405.00]                                                                       ", "391.29")]
        [TestCase("FTMS + p NSI d SIM ms [613.00-623.00]                                                                                        ", "0")]
        [TestCase("FTMS + c NSI d Full ms2 632.55@etd100.00 [100.00-2000.00]                                                                    ", "632.55")]
        [TestCase("FTMS + p NSI d sa Full ms2 858.56@etd33.33 [100.00-2000.00]                                                                  ", "858.56")]
        [TestCase("FTMS + p NSI Full ms3 1395.00@cid40.00 769.00@cid26.00 [210.00-2000.00]                                                      ", "1395.00, 769.00!")]
        [TestCase("FTMS + p NSI d sa Full ms2 686.2169@etd10.00@hcd10.00 [110.0000-2000.0000]                                                   ", "686.2169")]
        [TestCase("FTMS + p NSI d sa Full ms2 686.2169@etd10.00@cid10.00 [110.0000-2000.0000]                                                   ", "686.2169")]
        [TestCase("FTMS + c NSI d sa Full ms2 430.89@etd50.00 [100.00-1735.00]                                                                  ", "430.89")]
        [TestCase("ITMS + c NSI d Full ms2 327.01@etd500.00 [50.00-1320.00]                                                                     ", "327.01")]
        [TestCase("FTMS - c ESI d Full ms2 255.23@hcd30.00 [90.00-525.00]                                                                       ", "255.23")]
        [TestCase("ITMS - c ESI d Full ms2 255.23@cid35.00 [50.00-525.00]                                                                       ", "255.23")]
        [TestCase("FTMS {1,1}  - p ESI Full ms [150.00-1800.00]                                                                                 ", "0")]
        [TestCase("ITMS - p NSI Full ms2 988.50@cid0.00 [270.00-1000.00]                                                                        ", "988.50")]
        [TestCase("FTMS {1,1}  - p NSI Full ms [150.00-1000.00]                                                                                 ", "0")]
        [TestCase("ITMS + c NSI r d w Full ms2 255.27@cid35.00 [60.00-2000.00]                                                                  ", "255.27")]
        [TestCase("ITMS - c ESI Full ms [65.00-800.00]                                                                                          ", "0")]
        [TestCase("ITMS + c ESI Full ms [65.00-800.00]                                                                                          ", "0")]
        [TestCase("+ c NSI Full ms [400.00-2000.00]                                                                                             ", "0")]
        [TestCase("+ c NSI d Full ms2 550.74@cid35.00 [140.00-1115.00]                                                                          ", "550.74")]
        [TestCase("FTMS + p ESI d Full ms2 112.89@cid35.00 [50.00-240.00]                                                                       ", "112.89")]
        [TestCase("+ c NSI Q3MS [380.000-1350.000]                                                                                              ", "0")]
        [TestCase("FTMS + c NSI d SIM ms [782.00-792.00]                                                                                        ", "0")]
        [TestCase("FTMS {0,0}  + p NSI Full ms [400.00-2000.00]                                                                                 ", "0")]
        [TestCase("ITMS + c NSI d SIM ms [428.00-438.00]                                                                                        ", "0")]
        [TestCase("FTMS {1,1}  + p NSI Full ms2 1000.00@hcd25.00 [300.00-2000.00]                                                               ", "1000.00")]
        [TestCase("FTMS {1,1}  + p NSI sid=35.00  Full ms [300.00-2000.00]                                                                      ", "0")]
        [TestCase("FTMS + c NSI d sa Full ms2 738.2079@etd19.29@hcd20.00 [120.0000-2000.0000]                                                   ", "738.2079")]
        [TestCase("FTMS + c NSI k d Full ms3 978.7619@hcd30.00 256.2410@hcd65.00 [110.0000-500.0000]                                            ", "978.7619, 256.2410!")]
        [TestCase("FTMS - p NSI d Full ms2 1082.08@hcd30.00 [148.67-2230.00]                                                                    ", "1082.08")]
        [TestCase("FTMS + c NSI sid=30.00  d Full ms2 453.79@cid35.00 [110.00-2000.00]                                                          ", "453.79")]
        [TestCase("+ c EI SRM ms2 160.000 [72.999-73.001]                                                                                       ", "160.000")]
        [TestCase("FTMS + p NSI d Full ms3 850.70@cid35.00 756.71@cid35.00 [195.00-2000.00]                                                     ", "850.70, 756.71!")]
        [TestCase("FTMS + p NSI sid=35.00  d Full ms2 501.11@cid35.00 [125.00-2000.00]                                                          ", "501.11")]
        [TestCase("+ c EI Q1MS [50.000-600.000]                                                                                                 ", "0")]
        [TestCase("+ c CI Q1MS [50.000-600.000]                                                                                                 ", "0")]
        [TestCase("FTMS - p ESI d Full ms2 87.01@hcd45.00 [50.00-185.00]                                                                        ", "87.01")]
        [TestCase("FTMS + p ESI d Full ms2 445.12@hcd60.00 [100.00-460.00]                                                                      ", "445.12")]
        [TestCase("ITMS + c NSI t d Full ms2 815.2148@cid35.00 [219.0000-1641.0000]                                                             ", "815.2148")]
        [TestCase("FTMS + p NSI sps d Full ms3 815.2148@cid35.00 708.8861@hcd65.00 [120.0000-500.0000]                                          ", "815.2148, 708.8861!")] // ms2 is cid
        [TestCase("+ c NSI SIM pr 95.099 [105.099-105.101, 150.099-150.101, 370.199-370.201, 208.099-208.101, 300.199-300.201, 304.199-304.201] ", "0")]
        [TestCase("+ c NSI Full pr 1000.000 [150.000-1500.000]                                                                                  ", "0")]
        [TestCase("+ c NSI d Full ms2 150.100 [10.000-155.100]                                                                                  ", "150.100")]
        [TestCase("+ c NSI Q1MS [150.000-1500.000]                                                                                              ", "0")]
        [TestCase("ITMS + c NSI d Z ms [428.00-438.00]                                                                                          ", "0")]
        [TestCase("FTMS + c NSI Full ms2 779.60@etd25.00 [210.00-2000.00]                                                                       ", "779.60")]
        [TestCase("ITMS + c NSI r d Full ms3 617.4266@cid35.00 277.2909@cid35.00 [71.0000-842.0000]                                             ", "617.4266, 277.2909!")]
        [TestCase("FTMS + c NSI d sa Full ms2 963.2524@etd120.55@cid10.00 [120.0000-1937.0000]                                                  ", "963.2524")]
        [TestCase("+ p NSI Full ms2 713.950 [200.070-1500.000]                                                                                  ", "713.950")]
        [TestCase("+ p NSI Q3MS [200.070-1300.000]                                                                                              ", "0")]
        [TestCase("- p NSI Q3MS [150.000-1500.000]                                                                                              ", "0")]
        [TestCase("FTMS + p NSI sid=15.00  d Full ms2 820.19@hcd25.00 [400.00-2000.00]                                                          ", "820.19")]
        [TestCase("ITMS - p NSI sid=15.00  Full ms [500.00-2000.00]                                                                             ", "0")]
        [TestCase("+ c ESI Full ms [400.00-2000.00]                                                                                             ", "0")]
        ...
        [TestCase("ASTMS + c NSI d Full ms2 833.4459@hcd28.15 [150.0000-1500.0000]                ", "ASTMS + c NSI d Full ms2 0@hcd28.00", false, true)]
        [TestCase("ASTMS + c NSI d Full ms2 833.4459@hcd28.50 [150.0000-1500.0000]                ", "ASTMS + c NSI d Full ms2 0@hcd28.00", false, true)]
        [TestCase("ASTMS + c NSI d Full ms2 833.4459@hcd28.55 [150.0000-1500.0000]                ", "ASTMS + c NSI d Full ms2 0@hcd29.00", false, true)]
        [TestCase("ASTMS + c NSI d Full ms2 833.4459@hcd28.85 [150.0000-1500.0000]                ", "ASTMS + c NSI d Full ms2 0@hcd29.00", false, true)]
        [TestCase("MRTOF + c NSI d Full ms2 833.4459@hcd28.85 [150.0000-1500.0000]                ", "MRTOF + c NSI d Full ms2 0@hcd29.00", false, true)]
        [TestCase("ASTMS + c NSI d Full ms2 833.4459@hcd28.15 [150.0000-1500.0000]                ", "ASTMS + c NSI d Full ms2 0@hcd28.15", false, false)]
        [TestCase("ASTMS + c NSI d Full ms2 833.4459@hcd28.50 [150.0000-1500.0000]                ", "ASTMS + c NSI d Full ms2 0@hcd28.50", false, false)]
        [TestCase("ASTMS + c NSI d Full ms2 833.4459@hcd28.55 [150.0000-1500.0000]                ", "ASTMS + c NSI d Full ms2 0@hcd28.55", false, false)]
        [TestCase("ASTMS + c NSI d Full ms2 833.4459@hcd28.85 [150.0000-1500.0000]                ", "ASTMS + c NSI d Full ms2 0@hcd28.85", false, false)]
        ...
        public void TestGenericScanFilter(
            ...
            bool roundCollisionEnergyForAstral = true)
        {
            var genericFilterResult = XRawFileIO.MakeGenericThermoScanFilter(filterText, includeParentMZ, roundCollisionEnergyForAstral);

            Console.WriteLine(filterText + " " + genericFilterResult);

            Assert.That(genericFilterResult, Is.EqualTo(expectedResult));
        }
        ...
        [TestCase("ASTMS + c NSI d Full ms2 833.4459@hcd28.55 [150.0000-1500.0000]                             ", "HCD-HMSn")]
        ...
        public void TestScanTypeName(string filterText, string expectedResult, bool isDIA = false, double? parentIonMonoisotopicMZ = null)
        {
            ...
            Assert.That(scanTypeName, Is.EqualTo(expectedResult));
        }
        ...
        [TestCase("ASTMS + c NSI d Full ms2 833.4459@hcd28.55 [150.0000-1500.0000]                   ", false, 2, false, MRMScanTypeConstants.NotMRM, false)]
